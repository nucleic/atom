...
class CAtom:
    ...
    def observe(self, member: str, func: Callable[[ChangeDict], None]) -> None: ...
...
class Member(Generic[T, S]):
    ...
    @overload
    def add_static_observer(self, observer: str | Callable[..., None], change_types: MemberChange) -> Any: ...
    ...
    @overload
    def has_observer(self, observer: str | Callable[..., None], change_types: MemberChange) -> Any: ...
    @overload
    def has_observers(self) -> bool: ...
    @overload
    def has_observers(self, change_types: MemberChange) -> bool: ...
