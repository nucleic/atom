...
class CAtom:
    ...
    def has_observer(self, member: str, func: Callable[[TDict[str, Any]]]) -> bool: ...
    def has_observers(self, member: str) -> bool: ...
    def notifications_enabled(self) -> bool: ...
    def notify(self, member_name: str, *args, **kwargs) -> None: ...
    def observe(self, member: str, func: Callable[[TDict[str, Any]]]) -> None: ...
    def set_notifications_enabled(self, enabled: bool) -> bool: ...
    def unobserve(self, member: str, func: Callable[[TDict[str, Any]]]) -> None: ...
...
class Member(Generic[T, S]):
    ...
    def set_default_value_mode(
        self, mode: DefaultValue.List, context: list
    ) -> None: ...
    @overload
    def set_default_value_mode(self, mode: DefaultValue.Set, context: set) -> None: ...
    @overload
    def set_default_value_mode(
        self, mode: DefaultValue.Dict, context: dict
    ) -> None: ...
    @overload
    def set_default_value_mode(
        self, mode: DefaultValue.Delegate, context: Member
    ) -> None: ...
    @overload
    def set_default_value_mode(
        self, mode: DefaultValue.CallObject, context: Callable[[], Any]
    ) -> None: ...
    @overload
    def set_default_value_mode(
        self, mode: DefaultValue.CallObject_Object, context: Callable[[CAtom], Any]
    ) -> None: ...
    @overload
    def set_default_value_mode(
        self,
    ...
    def set_default_value_mode(
        ...
        mode: Union[
            ...
            DefaultValue.ObjectMethod_Name,
    ...
    @overload
    def set_default_value_mode(
        self, mode: DefaultValue.Static, context: Any
    ) -> None: ...
    @overload
    def set_default_value_mode(
        self, mode: DefaultValue.NoOp, context: None
    ) -> None: ...
    # Delattr mode
    @overload
    def set_delattr_mode(self, mode: DelAttr.Delegate, context: Member) -> None: ...
    @overload
    def set_delattr_mode(
        self, mode: DelAttr.Property, context: Optional[Callable[[CAtom], None]]
    ) -> None: ...
    @overload
    def set_delattr_mode(
        self,
    ...
    # Getattr mode
    @overload
    def set_getattr_mode(self, mode: GetAttr.Delegate, context: Member) -> None: ...
    @overload
    def set_getattr_mode(
        self,
        mode: Union[GetAttr.Property, GetAttr.CachedProperty],
        context: Optional[Callable[[CAtom], Any]],
    ) -> None: ...
    @overload
    def set_getattr_mode(
        self, mode: GetAttr.CallObject_Object, context: Callable[[CAtom], Any]
    ) -> None: ...
    @overload
    def set_getattr_mode(
        self, mode: GetAttr.CallObject_ObjectName, context: Callable[[CAtom, str], Any]
    ) -> None: ...
    @overload
    def set_getattr_mode(
        self,
        mode: Union[
            GetAttr.ObjectMethod,
            GetAttr.ObjectMethod_Name,
            GetAttr.MemberMethod_Object,
        ],
        context: str,
    ) -> None: ...
    @overload
    def set_getattr_mode(
        self,
        mode: Union[GetAttr.Event, GetAttr.NoOp, GetAttr.Signal, GetAttr.Slot],
        context: str,
    ) -> None: ...
    # Post getattr mode
    @overload
    def set_post_getattr_mode(self, mode: PostGetAttr.NoOp, context: None) -> None: ...
    @overload
    def set_post_getattr_mode(
        self, mode: PostGetAttr.Delegate, context: Member
    ) -> None: ...
    @overload
    def set_post_getattr_mode(
        self,
        mode: Union[
            PostGetAttr.ObjectMethod_Value,
            PostGetAttr.ObjectMethod_NameValue,
            PostGetAttr.MemberMethod_ObjectValue,
        ],
        context: Member,
    ) -> None: ...
    # Post setattr mode
    @overload
    def set_post_setattr_mode(self, mode: PostSetAttr.NoOp, context: None) -> None: ...
    @overload
    def set_post_setattr_mode(
        self, mode: PostSetAttr.Delegate, context: Member
    ) -> None: ...
    @overload
    def set_post_setattr_mode(
        self,
        mode: Union[
            PostSetAttr.ObjectMethod_OldNew,
            PostSetAttr.ObjectMethod_NameOldNew,
            PostSetAttr.MemberMethod_ObjectOldNew,
        ],
        context: str,
    ) -> None: ...
    # Post validate mode
    ...
    def set_post_validate_mode(
        self, mode: PostValidate.NoOp, context: None
    ) -> None: ...
    @overload
    def set_post_validate_mode(
        self, mode: PostValidate.Delegate, context: Member
    ) -> None: ...
    @overload
    def set_post_validate_mode(
        self,
        mode: Union[
            PostValidate.ObjectMethod_OldNew,
            PostValidate.ObjectMethod_NameOldNew,
            PostValidate.MemberMethod_ObjectOldNew,
        ],
        context: str,
    ) -> None: ...
    # Setattr mode
    ...
    @overload
    def set_setattr_mode(self, mode: SetAttr.Delegate, context: Member) -> None: ...
    @overload
    def set_setattr_mode(
        self,
        mode: SetAttr.Property,
        context: Optional[Callable[[CAtom], Any]],
    ) -> None: ...
    @overload
    def set_setattr_mode(
        self, mode: SetAttr.CallObject_ObjectValue, context: Callable[[CAtom, Any], Any]
    ) -> None: ...
    @overload
    def set_setattr_mode(
        self,
        mode: SetAttr.CallObject_ObjectNameValue,
    ...
    def set_setattr_mode(
        self,
        mode: Union[
            SetAttr.ObjectMethod_Value,
            SetAttr.ObjectMethod_NameValue,
            SetAttr.MemberMethod_ObjectValue,
        ],
        context: str,
    ) -> None: ...
    # Validate mode
    ...
    def set_validate_mode(
        ...
        mode: Union[
            Validate.Bool,
            Validate.Bytes,
            Validate.BytesPromote,
            Validate.Callable,
            Validate.Float,
            Validate.FloatPromote,
            Validate.Int,
            Validate.IntPromote,
            Validate.NoOp,
            Validate.Str,
    ...
    def set_validate_mode(
        self,
        mode: Union[
            Validate.Tuple, Validate.List, Validate.ContainerList, Validate.Set
        ],
    ...
    def set_validate_mode(
        self,
        mode: Union[Validate.Instance, Validate.Subclass],
        context: Union[type, Tuple[type, ...]],
    ) -> None: ...
    @overload
    def set_validate_mode(self, mode: Validate.Typed, context: type) -> None: ...
    @overload
    def set_validate_mode(self, mode: Validate.Enum, context: Sequence) -> None: ...
    @overload
    def set_validate_mode(
        self,
        mode: Validate.FloatRange,
    ...
    def set_validate_mode(
        self,
        mode: Validate.Coerced,
        context: Tuple[Type[T], Callable[[Any], T]],
    ) -> None: ...
    @overload
    def set_validate_mode(self, mode: Validate.Delegate, context: Member) -> None: ...
    @overload
    def set_validate_mode(
        self,
        mode: Union[
            Validate.ObjectMethod_OldNew,
            Validate.ObjectMethod_NameOldNew,
            Validate.MemberMethod_ObjectOldNew,
        ],
        context: str,
    ) -> None: ...
