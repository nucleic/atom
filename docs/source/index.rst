...
.. list-table::
    ...
    * - :doc:`get_started/index`
        ...
        The first stop for all those new to Atom. This section includes
        an introduction to Atom, installation instructions, and all the
        information needed to write your first Atom application.
    ...
    * - :doc:`arch_ref/index`
        ...
        the low level details of Atom's architecture and implementation.
        Look here if you want to understand how Atom works internally, or
        if you are interested in extending Atom for your own custom needs.
    ...
    * - :doc:`faqs/index`
      ...
      - :doc:`api_ref/index`
        ...
        to the most definitive Atom documentation: the source.
